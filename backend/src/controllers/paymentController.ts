    ...
    res.json({
      ...
      data: {
        ...
        kbank: {
          ...
          apiMode: kbankConf.apiMode,
          openapiReady: kbankConf.openapiReady,
          legacyConfigured: kbankConf.legacyConfigured,
          sandboxTestHeadersActive: kbankConf.sandboxTestHeadersActive,
